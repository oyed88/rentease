      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        <div className="bg-white rounded-2xl shadow-lg p-10 max-w-md w-full text-center">
          ...
          <div className="bg-orange-50 rounded-xl p-4 mb-6 text-left">
            <p className="text-sm text-gray-700">📅 <strong>Date:</strong> {date}</p>
            <p className="text-sm text-gray-700 mt-1">🕐 <strong>Time:</strong> {time}</p>
            <p className="text-sm text-gray-700 mt-1">📞 <strong>We will call:</strong> {phone}</p>
          </div>
        ...
        <div className="p-6">
          ...
          <div className="bg-gray-50 rounded-xl px-4 py-3 mb-5 text-xs text-gray-500 flex gap-2">
            ...
            <span>
              ...
              Only the RentEase admin can see them.
            </span>
          </div>
